...
from blog.models import Post, Ingredient, Comment
...
def display_post(request, post_id):
    ...
    return render(request, "PostDetails.html", { "post" : post, "ingredients": ingredients, "comments": comments })
...
def add_comment(request, post_id):
    ...
    if request.method == 'POST':
        ...
        return redirect('DisplayPost', post_id=post.id)  # Ensure 'display_post' matches your URL name
